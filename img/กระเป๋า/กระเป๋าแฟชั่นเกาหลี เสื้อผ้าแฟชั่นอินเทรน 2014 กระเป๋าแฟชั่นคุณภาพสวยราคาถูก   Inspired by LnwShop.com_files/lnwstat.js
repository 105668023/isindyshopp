...
var a=c.se()+"&"+bc.se()+"&"+ct.se()+"&"+_lnwstat.se();var i="";i+='<a href="http://www.lnw.co.th/">';i+='<img src="http://'+_lnws+'/lnwstat.gif?'+a+'" border="0" />';i+='</a>';_d.write(i);}};if(typeof(_lnwl)!="undefined"){return;}
